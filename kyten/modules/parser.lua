...
local Keywords = {"putln","format","for","end","if","else","elseif","while","public","static","||", "&&", "import","func","return"}
local ints = {'1','2','3','4','5','6','7','8','9','0'}

function import(filename)
  importing = true
  if filename == "taks" then
    filename = "kyten/modules/"..filename
    require(filename)
  elseif filename == "parse" then
    require("kyten/modules/parser")
  elseif string.find(filename,"<lua>") ~= nil then
    filename = string.gsub(filename, "<lua>", "")
    if io.open(filename..".lua") == nil then
      print("Kyte: '"..filename..".lua' No such file or directory found")
    ...
    if io.open(filename..".ky") == nil then
      print("Kyten: '"..filename..".ky' No such file or directory found")
      print("\027[31mexit status 1\027[0m")
      os.exit()
    end
    parse(filename)
...
local function search(table, value)
  local num = 0
...
function table.place(table, position, value)
...
function parse(f)
  ...
  file:close()
  if string.find(l[1],'format "sh.io"') == nil and not importing and fileName == "index" then
    print("Kyten: [index.ky] missing format type 'sh.io'")
    os.exit()
  end
  if string.find(l[1],'@format "sh.io"') ~= nil and #l[1] > #"@format " and fileName == "index" then
    table.remove(l,1)
  elseif string.find(l[1],'@format "lib.module"') == nil and fileName ~= "index" then
    print("Kyten: ["..fileName..".ky] missing or improper format type")
    os.exit()
  else
...
-- Variables, Tables, And Bools
  ...
  for l,v in pairs(tble) do
    ...
    if split_string[currentPosition] == "p" and split_string[currentPosition+1] == "a" and split_string[currentPosition+2] == "i" and split_string[currentPosition+3] == "r" and split_string[currentPosition+4] == "s" and not inString or split_string[currentPosition] == "i" and split_string[currentPosition+1] == "p" and split_string[currentPosition+2] == "a" and split_string[currentPosition+3] == "i" and split_string[currentPosition+4] == "r" and split_string[currentPosition+5] == "s" and not inString then
      ip_p = true
    elseif split_string[currentPosition] == "s" and split_string[currentPosition+1] == "e" and split_string[currentPosition+2] == "l" and not inString then
    ...
    elseif tokenTable[currentPosition] == "Function/Method Character" and ws then
      ...
      ws = false
    elseif split_string[currentPosition] == "!" and ifs or split_string[currentPosition] == "!" and ws then
      tble[currentPosition] = "~"
    ...
    elseif split_string[currentPosition] == "i" and split_string[currentPosition+1] == "m" and split_string[currentPosition+2] == "p" and split_string[currentPosition+3] == "o" and split_string[currentPosition+4] == "r" and split_string[currentPosition+5] == "t" and tokenTable[currentPosition+6] == "whitespace" and not inString then
      tble[currentPosition] = "i"
      tble[currentPosition+1] = "m"
      tble[currentPosition+2] = "p"
      tble[currentPosition+3] = "o"
    ...
    if split_string[currentPosition] == "s" and split_string[currentPosition+1] == "t" and split_string[currentPosition+2] == "a" and split_string[currentPosition+3] == "t" and split_string[currentPosition+4] == "i" and split_string[currentPosition+5] == "c" and not inString then
    ...
    elseif
      split_string[currentPosition] == "p" and split_string[currentPosition+1] == "u" and split_string[currentPosition+2] == "b" and split_string[currentPosition+3] == "l" and split_string[currentPosition+4] == "i" and split_string[currentPosition+5] == "c" and not inString then
      tble[currentPosition] = ""
      tble[currentPosition+1] = ""
      tble[currentPosition+2] = ""
      tble[currentPosition+3] = ""
    ...
    if split_string[currentPosition] == "e" and split_string[currentPosition+1] == "r" and split_string[currentPosition+2] == "r" and tokenTable[currentPosition+3] == "whitespace" and not comment and not multiLineComment and not inString then
      tble[currentPosition+2] = "r("
      pv = true
    end
  ...
  for _,i in pairs(syntaxTable) do
    ...
    if vl == "#" and not pmultiLineComment then
      pmultiLineComment = true
    elseif vl == "#" and pmultiLineComment then
      pmultiLineComment = false
    end
    if string.find(i,"::<@String>") ~= nil and string.find(i,"'") == nil and string.find(i, '"') == nil then 
      print("Kyten: "..fileName..".ky: <type error>\ntraceback:\n\t[ky]: varible type does not match set type 'String'\n\t[file]: "..fileName..".ky\n\t[line]: ".._)
      os.exit()
    elseif string.find(i, "::<@Integer>") ~= nil then
      local nf = false
      if string.find(i, "'") ~= nil or string.find(i,'"') ~= nil then
        print("Kyten: "..fileName..".ky: <type error>\ntraceback:\n\t[ky]: Varible type does not match set type 'Integer'\n\t[file]: "..fileName..".ky\n\t[line]: ".._)
        os.exit()
      elseif string.find(i, "%.") ~= nil then
        print("Kyten: "..fileName..".ky: <type error>\ntraceback:\n\t[ky]: Varible type does not match set type 'Integer'\n\t[file]: "..fileName..".ky\n\t[line]: ".._)
        os.exit()
      else
        for line,number in pairs(ints) do
          if string.find(i,number) ~= nil then
            nf = true
            break
          end
        end
    ...
    elseif string.find(i,"::<@Float>") ~= nil then
      if string.find(i, "'") ~= nil or string.find(i,'"') ~= nil then
        print("Kyten: "..fileName..".ky: <type error>\ntraceback:\n\t[ky]: Varible type does not match set type 'Float'\n\t[file]: "..fileName..".ky\n\t[line]: ".._)
        os.exit()
      end
    elseif string.find(i,"::<@Char>") ~= nil then
      if string.find(i,'%"%w"') == nil and string.find(i,"%'%w'") == nil then
        print("Kyten: "..fileName..".ky: <type error>\ntraceback:\n\t[ky]: Varible type does not match set type 'Char'\n\t[file]: "..fileName..".ky\n\t[line]: ".._)
        os.exit()
      end
    end
    if vl ~= nil and vl ~= ";" and vl ~= "{" and vl ~= "#" and not pmultiLineComment and not ptv or vl == "," and not ptv then
      print("Kyten: "..fileName..".ky: <eol> syntax error")
      print("traceback:\n\t[ky]: ';' expected")
      print("\t[file]: "..fileName..".ky\n\t[line]: ".._)
      os.exit()
    elseif vl ~= "," and ptv and string.find(syntaxTable[_+1],"}") == nil and #syntaxTable[_] > 0 and #syntaxTable[_+1] > 0 and ptv and string.find(syntaxTable[_],"{") == nil and not ignore then
      print("Kyten: "..fileName..".ky:".._..": <eol> syntax error")
      print("traceback:\n\t[ky]: ',' expected")
      print("\t[file]: "..fileName..".ky\n\t[line]: ".._)
      os.exit()
    end
  ...
  for _,h in pairs(syntaxTable) do
    ...
    for k,v in pairs(Keywords) do
      if string.find(h,v) ~= nil then
        found_kw = true
        if v == Keywords[3] or v == Keywords[5] and string.find(h, Keywords[6]) == nil or v == Keywords[8] or v == Keywords[14] then
          errorLineNumber = _
      ...
      for p,m in pairs(Keywords) do
        if string.find(h, m) ~= nil and #h == #m or string.find(h, m) ~= nil and #h == #m+1 then
          print("Kyten: "..fileName..".ky: <syntax error>\ntraceback:\n\t[ky]: unexpected '"..m.."' in line ".._.."\n\t[file]: "..fileName..".ky\n\t[line]: ".._)
      os.exit()
        end
      end
    end
